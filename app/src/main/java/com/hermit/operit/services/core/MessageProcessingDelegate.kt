...
import com.hermit.core.tools.agent.PhoneAgentJobRegistry
import com.hermit.data.model.*
import com.hermit.data.model.InputProcessingState as EnhancedInputProcessingState
            ...
            try {
                ...
                val (provider, modelName) = try {
                    service.getDisplayProviderAndModelForFunction(
                        functionType = com.hermit.data.model.FunctionType.CHAT,
                        chatModelConfigIdOverride = chatModelConfigIdOverride,
                        chatModelIndexOverride = chatModelIndexOverride
                    )
                } catch (e: Exception) {
