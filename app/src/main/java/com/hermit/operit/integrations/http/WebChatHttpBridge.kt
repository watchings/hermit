...
import com.hermit.api.chat.llmprovider.MediaLinkParser
...
import com.hermit.data.model.CharacterGroupCard
...
import com.hermit.data.preferences.ThemePreferenceSnapshot
import com.hermit.data.preferences.ToolCollapseMode
import com.hermit.data.preferences.UserPreferencesManager
import com.hermit.integrations.http.bridge.WebChatActionBridge
import com.hermit.data.repository.ChatHistoryManager
import com.hermit.integrations.http.bridge.WebChatInputSettingsBridge
import com.hermit.integrations.http.bridge.WebChatMemorySelectorBridge
import com.hermit.integrations.http.bridge.WebChatManagementBridge
import com.hermit.integrations.externalchat.ExternalChatResponseSanitizer
import com.hermit.services.core.MAX_DISPLAY_PAGE_COUNT
import com.hermit.services.core.resolveDisplayPageRanges
import com.hermit.util.AppLogger
import com.hermit.util.ChatMarkupRegex
import com.hermit.util.StructuredAssistantContentParser
import com.hermit.ui.theme.resolveThemeColorScheme
...
import com.hermit.util.stream.SharedStream
