...
import com.hermit.integrations.a2a.A2aHttpHandler
import com.hermit.integrations.externalchat.ExternalChatAcceptedResponse
import com.hermit.integrations.externalchat.ExternalChatHealthResponse
import com.hermit.integrations.externalchat.ExternalChatHttpRequest
import com.hermit.integrations.externalchat.ExternalChatRequestExecutor
import com.hermit.integrations.externalchat.ExternalChatResponseMode
import com.hermit.integrations.externalchat.ExternalChatResponseSanitizer
import com.hermit.integrations.externalchat.ExternalChatResult
import com.hermit.integrations.externalchat.ExternalChatStreamEnvelope
import com.hermit.integrations.externalchat.ExternalChatStreamingStartResult
...
class ExternalChatHttpServer(
    ...
    private fun sseResponse(request: ExternalChatHttpRequest, resolvedRequestId: String): Response {
        ...
        val streamingSessionRef =
            AtomicReference<com.hermit.integrations.externalchat.ExternalChatStreamingSession?>(
                null
            )
