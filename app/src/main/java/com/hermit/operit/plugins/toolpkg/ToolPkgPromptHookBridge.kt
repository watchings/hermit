...
import com.hermit.core.chat.hooks.PromptFinalizeHook
import com.hermit.core.chat.hooks.PromptEstimateFinalizeHook
import com.hermit.core.chat.hooks.PromptEstimateHistoryHook
import com.hermit.core.chat.hooks.PromptHistoryHook
import com.hermit.core.chat.hooks.PromptHookContext
import com.hermit.core.chat.hooks.PromptHookMutation
import com.hermit.core.chat.hooks.PromptHookRegistry
import com.hermit.core.chat.hooks.PromptInputHook
import com.hermit.core.chat.hooks.PromptTurn
import com.hermit.core.chat.hooks.PromptTurnKind
import com.hermit.core.chat.hooks.SystemPromptComposeHook
import com.hermit.core.chat.hooks.ToolPromptComposeHook
import com.hermit.core.tools.packTool.PackageManager
import com.hermit.core.tools.packTool.ToolPkgContainerRuntime
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_PROMPT_FINALIZE
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_PROMPT_ESTIMATE_FINALIZE
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_PROMPT_ESTIMATE_HISTORY
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_PROMPT_HISTORY
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_PROMPT_INPUT
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_SYSTEM_PROMPT_COMPOSE
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_TOOL_PROMPT_COMPOSE
