...
import com.hermit.data.dao.ChatContentDao
import com.hermit.data.dao.ChatDao
import com.hermit.data.dao.MessageDao
import com.hermit.data.dao.MessageVariantDao
import com.hermit.data.dao.TokenUsageDao
...
import com.hermit.data.model.TokenStatsModelEntity
import com.hermit.data.model.TokenUsageRecordEntity
/** 应用数据库，包含聊天表和消息表 */
@Database(
    entities = [
        ChatEntity::class,
