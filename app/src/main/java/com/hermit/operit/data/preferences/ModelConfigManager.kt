...
import com.hermit.data.model.CustomParameterData
import com.hermit.data.model.FunctionType
import com.hermit.data.model.ModelConfigData
import com.hermit.data.model.ModelConfigDefaults
...
import com.hermit.data.model.ParameterValueType
import com.hermit.data.model.StandardModelParameters
import com.hermit.data.model.SummarySectionOverride
import com.hermit.data.model.ApiProviderType
import com.hermit.data.model.ApiKeyInfo
...
class ModelConfigManager(
    ...
    suspend fun updateModelConfig(
            ...
            apiEndpoint: String,
            modelName: String,
            apiProviderType: com.hermit.data.model.ApiProviderType,
        ...
        if (config.hasCustomParameters &&
            ...
            try {
                val customParamsData =
                        json.decodeFromString<List<com.hermit.data.model.CustomParameterData>>(
                                config.customParameters
                        )
...
private fun ModelParameter<*>.toCustomParameterData(): com.hermit.data.model.CustomParameterData {
    return com.hermit.data.model.CustomParameterData(
        id = this.id,
        name = this.name,
