...
/**
 * App-wide logger with an API closely mirroring [com.hermit.util.AppLogger].
 *
...
object AppLogger {
    ...
    // Mirror com.hermit.util.AppLogger priority constants
    ...
    // --- Public API mirroring com.hermit.util.AppLogger ---
