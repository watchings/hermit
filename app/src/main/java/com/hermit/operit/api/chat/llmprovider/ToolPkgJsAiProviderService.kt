...
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_CALCULATE_INPUT_TOKENS
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_LIST_MODELS
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_SEND_MESSAGE
import com.hermit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_TEST_CONNECTION
...
import com.hermit.plugins.toolpkg.ToolPkgAiProviderRegistration
import com.hermit.plugins.toolpkg.decodeToolPkgHookResult
import com.hermit.plugins.toolpkg.jsonObjectToMap
import com.hermit.plugins.toolpkg.toolPkgPackageManager
...
internal class ToolPkgJsAiProviderService(
    ...
    private suspend fun forwardUsage(
        usage: TokenUsage,
        onUsageReported: (suspend (com.hermit.data.stats.ProviderUsageSnapshot, Int) -> Unit)?,
    ) {
        onUsageReported?.invoke(
            com.hermit.data.stats.ProviderUsageNormalizer.toolPkg(
                input = usage.input,
