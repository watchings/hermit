...
import com.hermit.data.model.ParameterCategory
import com.hermit.data.stats.ProviderUsageNormalizer
...
open class GeminiProvider(
    ...
    private data class GeminiContentExtractionResult(
        val content: String,
        val usage: com.hermit.data.stats.ProviderUsageSnapshot?,
    ...
    private suspend fun processStreamingResponse(
        ...
        suspend fun reportUsage(usage: com.hermit.data.stats.ProviderUsageSnapshot?) {
    ...
    private suspend fun extractContentFromJson(
        ...
        var usage: com.hermit.data.stats.ProviderUsageSnapshot? = null
