...
import com.hermit.R
import com.hermit.api.speech.PersonalWakeListener
import com.hermit.api.speech.SpeechPrerollStore
import com.hermit.api.speech.SpeechService
...
import com.hermit.core.application.ForegroundServiceCompat
import com.hermit.data.preferences.ExternalHttpApiConfig
import com.hermit.data.preferences.ExternalHttpApiPreferences
import com.hermit.integrations.http.ExternalChatHttpServer
import com.hermit.integrations.http.ExternalChatHttpState
import com.hermit.services.FloatingChatService
import com.hermit.services.UIDebuggerService
...
class AIForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL_CURRENT_OPERATION = "com.hermit.action.CANCEL_CURRENT_OPERATION"
        private const val REQUEST_CODE_CANCEL_CURRENT_OPERATION = 9002

        private const val ACTION_EXIT_APP = "com.hermit.action.EXIT_APP"
        private const val REQUEST_CODE_EXIT_APP = 9003

        private const val ACTION_TOGGLE_WAKE_LISTENING = "com.hermit.action.TOGGLE_WAKE_LISTENING"
        ...
        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_IME =
            "com.hermit.action.SET_WAKE_LISTENING_SUSPENDED_FOR_IME"
    ...
    private fun triggerWakeLaunch() {
        ...
        try {
            val floatingIntent = Intent(this, FloatingChatService::class.java).apply {
                putExtra("INITIAL_MODE", com.hermit.ui.floating.FloatingMode.FULLSCREEN.name)
