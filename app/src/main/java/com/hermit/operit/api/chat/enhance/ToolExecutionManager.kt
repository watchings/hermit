...
import com.hermit.core.tools.AIToolHookDecision
...
import com.hermit.ui.common.displays.MessageContentParser
...
object ToolExecutionManager {
    ...
    private fun isInvocationAllowedForRoleCard(
        invocation: ToolInvocation,
        roleCardToolAccess: com.hermit.data.preferences.ResolvedCharacterCardToolAccess
    ): Boolean {
