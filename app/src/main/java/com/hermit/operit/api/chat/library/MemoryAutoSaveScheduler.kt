package com.hermit.api.chat.library
...
import com.hermit.data.model.MemoryAutoSaveCandidate
...
class MemoryAutoSaveScheduler(
    ...
    private suspend fun processChatCandidateGroup(
        ...
        chatContentDao: com.hermit.data.dao.ChatContentDao,
        toolHandler: AIToolHandler,
        memoryService: com.hermit.api.chat.llmprovider.AIService
    ) {
