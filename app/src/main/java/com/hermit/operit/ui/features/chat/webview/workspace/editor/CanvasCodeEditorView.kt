package com.hermit.ui.features.chat.webview.workspace.editor
...
import com.hermit.ui.features.chat.webview.workspace.editor.completion.CompletionItem
import com.hermit.ui.features.chat.webview.workspace.editor.completion.CompletionProvider
import com.hermit.ui.features.chat.webview.workspace.editor.completion.CompletionProviderFactory
import com.hermit.ui.features.chat.webview.workspace.editor.language.LanguageSupport
import com.hermit.ui.features.chat.webview.workspace.editor.theme.EditorTheme
import com.hermit.ui.features.chat.webview.workspace.editor.theme.getThemeForLanguage
...
class CanvasCodeEditorView @JvmOverloads constructor(
    ...
    private fun loadEditorTypeface(): Typeface {
        return try {
            resources.getFont(com.hermit.terminal.R.font.jetbrains_mono_nerd_font_regular)
        } catch (_: Exception) {
            Typeface.MONOSPACE
        }
    }
