package com.hermit.ui.features.websession.browser
...
import com.hermit.R
import com.hermit.core.tools.defaultTool.websession.browser.WebSessionBookmark
import com.hermit.core.tools.defaultTool.websession.browser.WebSessionBrowserHostState
import com.hermit.core.tools.defaultTool.websession.browser.WebSessionBrowserSheetRoute
import com.hermit.core.tools.defaultTool.websession.browser.WebSessionHistoryEntry
import com.hermit.core.tools.defaultTool.websession.browser.WebSessionPendingDialogState
import com.hermit.core.tools.defaultTool.websession.browser.WebSessionWebViewHost
import com.hermit.core.tools.defaultTool.websession.userscript.ui.WebSessionUserscriptUiState
...
private fun WebSessionOverlaySheetContent(
    ...
    browserState: com.hermit.core.tools.defaultTool.websession.browser.WebSessionBrowserState,
    bookmarks: List<WebSessionBookmark>,
    globalHistory: List<WebSessionHistoryEntry>,
    userscriptUiState: WebSessionUserscriptUiState,
    onDismiss: () -> Unit,
