package com.hermit.ui.main.screens
...
import com.hermit.R
import com.hermit.ui.common.NavItem
import com.hermit.ui.features.about.screens.AboutScreen
import com.hermit.ui.features.assistant.screens.AssistantConfigScreen
import com.hermit.ui.features.chat.screens.AIChatScreen
import com.hermit.ui.features.demo.screens.ShizukuDemoScreen
import com.hermit.ui.features.help.screens.HelpScreen
import com.hermit.ui.features.memory.screens.MemoryScreen
import com.hermit.ui.features.packages.screens.MarketHomeTab
import com.hermit.ui.features.packages.screens.PackageManagerScreen
import com.hermit.ui.features.packages.screens.ArtifactPublishScreen
import com.hermit.ui.features.packages.screens.RepoMarketPublishScreen
import com.hermit.ui.features.packages.screens.UnifiedMarketManageScreen
import com.hermit.ui.features.packages.screens.UnifiedMarketCategoryScreen
import com.hermit.ui.features.packages.screens.UnifiedMarketAuthorScreen
import com.hermit.ui.features.packages.screens.UnifiedMarketDetailEntryScreen
import com.hermit.ui.features.packages.screens.UnifiedMarketNotificationsScreen
import com.hermit.ui.features.packages.screens.UnifiedMarketScreen
import com.hermit.ui.features.packages.screens.marketCategoryLabel
import com.hermit.ui.features.packages.screens.toArtifactPublishClusterContext
...
import com.hermit.ui.features.packages.market.PluginCreationIntent
import com.hermit.ui.features.settings.screens.ChatBackupSettingsScreen
import com.hermit.ui.features.settings.screens.ChatHistorySettingsScreen
import com.hermit.ui.features.settings.screens.ContextSummarySettingsScreen
import com.hermit.ui.features.settings.screens.ExternalHttpChatSettingsScreen
import com.hermit.ui.features.settings.screens.FunctionalConfigScreen
import com.hermit.ui.features.settings.screens.GlobalDisplaySettingsScreen
import com.hermit.ui.features.settings.screens.GitHubAccountScreen
import com.hermit.ui.features.settings.screens.LanguageSettingsScreen
import com.hermit.ui.features.settings.screens.LayoutAdjustmentSettingsScreen
import com.hermit.ui.features.settings.screens.ModelConfigScreen
import com.hermit.ui.features.settings.screens.ModelConfigEntryMode
import com.hermit.ui.features.settings.screens.ModelPromptsSettingsScreen
import com.hermit.ui.features.settings.screens.TagMarketScreen
import com.hermit.ui.features.settings.screens.SettingsScreen
import com.hermit.ui.features.settings.screens.SpeechServicesSettingsScreen
import com.hermit.ui.features.settings.screens.ThemeSettingsScreen
import com.hermit.ui.features.settings.screens.ToolPermissionSettingsScreen
import com.hermit.ui.features.settings.screens.MnnModelDownloadScreen
import com.hermit.ui.features.settings.screens.UserPreferencesSettingsScreen
import com.hermit.ui.features.tokenstats.TokenUsageStatisticsScreen
import com.hermit.ui.features.token.TokenConfigWebViewScreen
import com.hermit.ui.features.toolbox.screens.AppPermissionsToolScreen
import com.hermit.ui.features.toolbox.screens.FileManagerToolScreen
import com.hermit.ui.features.toolbox.screens.LogcatToolScreen
import com.hermit.ui.features.toolbox.screens.ShellExecutorToolScreen
import com.hermit.ui.features.toolbox.screens.StreamMarkdownDemoScreen
import com.hermit.ui.features.toolbox.screens.TerminalAutoConfigToolScreen
import com.hermit.ui.features.toolbox.screens.TerminalToolScreen
import com.hermit.ui.features.toolbox.screens.ToolboxScreen
import com.hermit.ui.common.composedsl.ToolPkgComposeDslToolScreen
import com.hermit.ui.features.toolbox.screens.UIDebuggerToolScreen
import com.hermit.ui.features.toolbox.screens.DefaultAssistantGuideToolScreen
import com.hermit.ui.features.toolbox.screens.ProcessLimitRemoverToolScreen
import com.hermit.ui.features.toolbox.screens.sqlviewer.SqlViewerToolScreen
import com.hermit.ui.features.toolbox.screens.ffmpegtoolbox.FFmpegToolboxScreen
import com.hermit.ui.features.toolbox.screens.htmlpackager.HtmlPackagerScreen
import com.hermit.ui.features.toolbox.screens.speechtotext.SpeechToTextToolScreen
import com.hermit.ui.features.toolbox.screens.texttospeech.TextToSpeechToolScreen
import com.hermit.ui.features.toolbox.screens.tooltester.ToolTesterScreen
import com.hermit.ui.features.toolbox.screens.autoglm.AutoGlmOneClickToolScreen
import com.hermit.ui.features.toolbox.screens.autoglm.AutoGlmToolScreen
import com.hermit.ui.features.update.screens.UpdateScreen
import com.hermit.ui.features.workflow.screens.WorkflowListScreen
import com.hermit.ui.features.workflow.screens.WorkflowDetailScreen
import com.hermit.ui.main.PendingChatDraftHandler
import com.hermit.ui.main.navigation.AppRouterGateway
...
sealed class Screen(
         ...
         * [com.hermit.ui.main.navigation.ScreenRouteViewModelStoreOwnerManager]
    ...
    data class MarketEntryDetail(
        val entry: com.hermit.data.api.MarketV2Entry,
    ...
    data class ArtifactEdit(val editingEntry: com.hermit.data.api.MarketV2Entry) :
            Screen(navItem = NavItem.Packages, titleRes = R.string.screen_title_artifact_publish) {
        @Composable
        override fun Content(
                navController: NavController,
    ...
    data class RepoEdit(
        ...
        val editingEntry: com.hermit.data.api.MarketV2Entry
    ) : Screen(navItem = NavItem.Packages) {
        @Composable
        override fun Content(
                navController: NavController,
                    ...
                    onNavigationEntrySelected = { entry ->
                        ...
                        if (nativeScreen != null) {
                            ...
                            AppRouterGateway.navigate(
                                ...
                                source = com.hermit.ui.main.navigation.RouteEntrySource.DEFAULT
                            )
                        }
                    }
            )
    ...
    data object Agreement : Screen(navItem = NavItem.Agreement) {
        ...
        override fun Content(
            ...
            com.hermit.ui.features.agreement.screens.AgreementScreen(
    ...
    data object PersonaCardGeneration :
        ...
        override fun Content(
            ...
            com.hermit.ui.features.settings.screens.PersonaCardGenerationScreen(
                onNavigateToSettings = { navigateTo(Settings) },
                onNavigateToModelConfig = { navigateTo(ModelConfig) },
                onNavigateToModelPrompts = { navigateTo(ModelPromptsSettings) }
            )
    ...
    data object WaifuModeSettings :
        ...
        override fun Content(
            ...
            com.hermit.ui.features.settings.screens.WaifuModeSettingsScreen(
                onNavigateBack = onGoBack,
    ...
    data object CustomEmojiManagement :
        ...
        override fun Content(
            ...
            com.hermit.ui.features.settings.screens.CustomEmojiManagementScreen(
                onNavigateBack = onGoBack
            )
        }
    }
