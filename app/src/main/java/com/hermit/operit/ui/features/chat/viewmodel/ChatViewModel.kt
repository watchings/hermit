package com.hermit.ui.features.chat.viewmodel
...
import com.hermit.ui.features.chat.components.ChatStyle
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.hermit.api.chat.ChatRuntimeHolder
import com.hermit.api.chat.ChatRuntimeSlot
import com.hermit.api.chat.EnhancedAIService
import com.hermit.core.chat.AIMessageManager
import com.hermit.core.tools.AIToolHandler
import com.hermit.core.tools.FileOperationData
import com.hermit.data.collects.ApiProviderConfigs
import com.hermit.data.model.ApiKeyFormatValidator
...
import com.hermit.data.model.ChatMessageLocatorPreview
import com.hermit.data.model.FunctionType
import com.hermit.data.model.PromptFunctionType
import com.hermit.data.model.ToolParameter
import com.hermit.R
import com.hermit.ui.features.chat.webview.LocalWebServer
...
import com.hermit.ui.floating.ui.pet.AvatarEmotionManager
import com.hermit.api.voice.VoiceService
...
import com.hermit.util.WaifuMessageProcessor
import com.hermit.ui.features.chat.webview.workspace.WorkspaceBackupManager
import com.hermit.ui.features.chat.webview.workspace.CommandConfig
import com.hermit.ui.features.chat.webview.workspace.WorkspaceCommandExecutionState
import com.hermit.ui.features.chat.webview.workspace.WorkspaceConfigReader
import com.hermit.ui.features.chat.webview.workspace.WorkspacePreviewRefreshBus
import com.hermit.ui.features.chat.webview.workspace.WorkspacePreviewRefreshEvent
import com.hermit.ui.features.chat.webview.workspace.toWorkspaceCommandOutputEntries
import com.hermit.core.tools.system.Terminal
import com.hermit.util.TtsCleaner
import com.hermit.util.TtsSegmenter
import com.hermit.ui.features.chat.util.findMentionTokens
import com.hermit.ui.features.chat.util.findMentionTokenEndingAtCursor
import com.hermit.ui.features.chat.util.isMentionContinuation
import android.net.Uri
import android.os.Build
import androidx.annotation.RequiresApi
import java.io.File
// 使用 services/core 的 Delegate 类
import com.hermit.services.core.MessageProcessingDelegate
import com.hermit.services.core.ChatHistoryDelegate
import com.hermit.services.core.ApiConfigDelegate
import com.hermit.services.core.TokenStatisticsDelegate
import com.hermit.services.core.AttachmentDelegate
import com.hermit.services.core.MessageCoordinationDelegate
import com.hermit.data.model.InputProcessingState
import com.hermit.data.model.WorkspaceRenameResult
import com.hermit.services.ChatServiceCore
import com.hermit.services.ChatServiceUiBridge
import com.hermit.services.EmptyChatServiceUiBridge
import com.hermit.ui.features.chat.util.MessageImageGenerator
import com.hermit.ui.features.chat.components.CharacterSelectorTarget
...
class ChatViewModel(private val context: Context) : ViewModel() {
    ...
    private fun findLatestChatForCharacterCard(targetCard: com.hermit.data.model.CharacterCard): ChatHistory? {
