package com.hermit.ui.features.assistant.components
...
import com.hermit.core.avatar.common.state.AvatarMoodTypeDefinition
...
@Composable
fun ModelSelector(
    models: List<com.hermit.data.repository.AvatarConfig>,
