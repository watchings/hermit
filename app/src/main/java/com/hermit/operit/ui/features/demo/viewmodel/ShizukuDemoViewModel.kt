package com.hermit.ui.features.demo.viewmodel
...
import com.hermit.R
import com.hermit.ui.features.demo.state.DemoStateManager
...
class ShizukuDemoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val uiState: StateFlow<com.hermit.ui.features.demo.state.DemoScreenState> =
