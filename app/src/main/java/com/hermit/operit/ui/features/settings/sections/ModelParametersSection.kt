...
fun ModelParametersSection(
    ...
    // 状态
    var parameterToEdit by remember { mutableStateOf<com.hermit.data.model.CustomParameterData?>(null) }
...
private fun convertCustomParameterDataToModelParameter(
    customParam: com.hermit.data.model.CustomParameterData
): ModelParameter<*> {
...
): com.hermit.data.model.CustomParameterData {
...
private fun AddCustomParameterDialog(
    onDismiss: () -> Unit,
    onSave: (com.hermit.data.model.CustomParameterData) -> Unit,
    existingParam: com.hermit.data.model.CustomParameterData? = null
) {
