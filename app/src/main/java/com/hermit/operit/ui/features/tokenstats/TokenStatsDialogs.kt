...
import com.hermit.data.model.BillingMode
...
internal fun customRangeInclusiveEnd(
    ...
    zone: ZoneId,
): com.hermit.data.stats.TokenStatsTimeRange {
    ...
    return com.hermit.data.stats.TokenStatsTimeRanges.customRange(startMs, endMs)
}
...
internal fun TokenStatsDateRangeDialog(
    zone: ZoneId,
    maxRangeDays: Long,
    initialRange: com.hermit.data.stats.TokenStatsTimeRange?,
