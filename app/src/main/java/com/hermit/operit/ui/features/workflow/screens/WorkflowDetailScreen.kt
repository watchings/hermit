package com.hermit.ui.features.workflow.screens
...
import com.hermit.data.model.WorkflowNode
import com.hermit.data.model.TriggerNode
import com.hermit.data.model.ExecuteNode
import com.hermit.data.model.ConditionNode
import com.hermit.data.model.ConditionOperator
import com.hermit.data.model.LogicNode
import com.hermit.data.model.LogicOperator
import com.hermit.data.model.ExtractNode
import com.hermit.data.model.ExtractMode
import com.hermit.data.model.ParameterValue
import com.hermit.data.model.ToolParameterSchema
import com.hermit.data.model.WorkflowExecutionFailureStage
import com.hermit.data.model.WorkflowExecutionRecord
import com.hermit.ui.components.CustomScaffold
import com.hermit.ui.features.workflow.viewmodel.WorkflowViewModel
import com.hermit.ui.features.workflow.components.GridWorkflowCanvas
import com.hermit.ui.features.workflow.components.ConnectionMenuDialog
import com.hermit.ui.features.workflow.components.NodeActionMenuDialog
import com.hermit.ui.features.workflow.components.ScheduleConfigDialog
...
fun NodeDialog(
    ...
    val initialActionConfigPairs = if (node is ExecuteNode) {
        node.actionConfig.map { (key, paramValue) ->
            when (paramValue) {
                is com.hermit.data.model.ParameterValue.StaticValue -> 
                    ParameterConfig(key, false, paramValue.value)
                is com.hermit.data.model.ParameterValue.NodeReference -> 
