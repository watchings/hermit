package com.hermit.ui.features.token
...
import com.hermit.R
import com.hermit.ui.features.token.components.UrlConfigDialog
import com.hermit.ui.features.token.model.NavDestination
import com.hermit.ui.features.token.model.getIconForIndex
import com.hermit.ui.features.token.preferences.UrlConfigManager
...
fun TokenConfigWebViewScreen(onNavigateBack: () -> Unit) {
    ...
    // 获取URL配置
    val urlConfig by urlConfigManager.urlConfigFlow.collectAsState(initial = com.hermit.ui.features.token.model.UrlConfig())
