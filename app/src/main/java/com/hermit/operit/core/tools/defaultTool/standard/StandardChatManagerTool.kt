...
import com.hermit.core.tools.AgentStatusResultData
import com.hermit.core.tools.ChatCallResultData
import com.hermit.core.tools.ChatCallTurnInfo
import com.hermit.core.tools.ChatCreationResultData
import com.hermit.core.tools.ChatDeleteResultData
import com.hermit.core.tools.ChatFindResultData
import com.hermit.core.tools.ChatListResultData
import com.hermit.core.tools.ChatMessagesResultData
import com.hermit.core.tools.ChatServiceStartResultData
import com.hermit.core.tools.ChatSwitchResultData
import com.hermit.core.tools.ChatTitleUpdateResultData
import com.hermit.core.tools.CharacterCardListResultData
import com.hermit.core.tools.MessageSendResultData
import com.hermit.core.tools.MessageSendStreamEventData
...
class StandardChatManagerTool(private val context: Context) {
    ...
    private fun buildChatMessagesResult(
        ...
        order: String,
        limit: Int,
        messages: List<com.hermit.data.model.ChatMessage>,
        start: Int? = null,
        end: Int? = null,
