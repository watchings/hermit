...
import com.hermit.core.tools.PackageToolExecutor
import com.hermit.core.tools.PackageTool
import com.hermit.core.tools.ToolPackage
import com.hermit.core.tools.ToolPackageState
import com.hermit.core.tools.agent.ShowerController
import com.hermit.core.tools.condition.ConditionEvaluator
import com.hermit.core.tools.javascript.JsEngine
import com.hermit.core.tools.mcp.MCPManager
import com.hermit.core.tools.mcp.MCPPackage
import com.hermit.core.tools.mcp.MCPServerConfig
import com.hermit.core.tools.mcp.MCPToolExecutor
import com.hermit.core.tools.skill.SkillManager
import com.hermit.data.security.PluginDenylistRepository
import com.hermit.data.preferences.SkillVisibilityPreferences
import com.hermit.core.tools.system.AndroidPermissionLevel
import com.hermit.core.tools.system.ShizukuAuthorizer
import com.hermit.data.preferences.DisplayPreferencesManager
import com.hermit.data.preferences.ApiPreferences
import com.hermit.data.model.Workflow
import com.hermit.data.preferences.EnvPreferences
import com.hermit.data.preferences.androidPermissionPreferences
import com.hermit.data.model.PackageToolPromptCategory
import com.hermit.data.model.ToolPrompt
import com.hermit.data.model.ToolResult
import com.hermit.ui.features.chat.webview.workspace.WorkspaceConfig
import com.hermit.widget.ToolPkgDesktopWidgetHost
import com.hermit.util.OperitPaths
import com.hermit.util.ToolPkgWasmRuntime
import java.io.File
...
private constructor(private val context: Context, private val aiToolHandler: AIToolHandler) {
    ...
    companion object {
        ...
        private const val PACKAGE_PREFS = "com.hermit.core.tools.PackageManager"
