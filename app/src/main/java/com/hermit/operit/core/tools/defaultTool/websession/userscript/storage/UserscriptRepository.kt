package com.hermit.core.tools.defaultTool.websession.userscript.storage

import android.content.Context
import android.util.Base64
import android.webkit.MimeTypeMap
import com.hermit.core.tools.defaultTool.websession.userscript.ParsedUserscriptMetadata
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptCapabilityRegistry
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptBootstrapPayload
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptExecutionPayload
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptInstallPreview
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptInstallSourceType
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptListItem
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptLogItem
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptMatcher
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptMetadataParser
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptRequireEntry
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptResourceEntry
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptResourcePayload
import com.hermit.core.tools.defaultTool.websession.userscript.UserscriptRunAt
