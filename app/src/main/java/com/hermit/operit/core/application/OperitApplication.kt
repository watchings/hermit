package com.hermit.core.application
...
import com.hermit.api.chat.AIForegroundService
import com.hermit.api.chat.library.MemoryAutoSaveScheduler
import com.hermit.plugins.PluginRegistry
...
import com.hermit.data.db.AppDatabase
...
import com.hermit.data.preferences.initAndroidPermissionPreferences
import com.hermit.data.preferences.initUserPreferencesManager
import com.hermit.data.preferences.preferencesManager
import com.hermit.data.repository.CustomEmojiRepository
import com.hermit.data.stats.TokenUsageRepository
import com.hermit.ui.features.chat.webview.LocalWebServer
import com.hermit.ui.features.chat.webview.workspace.editor.language.LanguageFactory
import com.hermit.util.GlobalExceptionHandler
import com.hermit.util.ImagePoolManager
import com.hermit.util.LocaleUtils
import com.hermit.util.MediaPoolManager
import com.hermit.util.CrashRecoveryState
import com.hermit.util.OperitPaths
import com.hermit.util.SkillRepoZipPoolManager
import com.hermit.util.SerializationSetup
...
import com.hermit.ui.common.displays.VirtualDisplayOverlay
import com.tom_roush.pdfbox.android.PDFBoxResourceLoader
import com.hermit.core.tools.system.shower.OperitShowerShellRunner
...
class OperitApplication : Application(), ImageLoaderFactory, WorkConfiguration.Provider {
    ...
    private fun initializeMainApplicationLocked() {
        ...
        applicationScope.launch {
            ...
            try {
                val bound = com.hermit.data.repository.UIHierarchyManager.bindToService(this@OperitApplication)
