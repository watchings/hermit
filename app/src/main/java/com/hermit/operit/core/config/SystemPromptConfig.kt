...
import com.hermit.ui.features.chat.webview.workspace.process.WorkspaceRuleFileReader
  ...
  suspend fun getSystemPrompt(
    ...
    val skillPackages = try {
        SkillRepository.getInstance(
            com.hermit.core.application.OperitApplication.instance.applicationContext
