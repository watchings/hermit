...
data class WorkflowDetailResultData(
    ...
    val name: String,
    val description: String,
    val nodes: List<com.hermit.data.model.WorkflowNode>,
    val connections: List<com.hermit.data.model.WorkflowNodeConnection>,
    val enabled: Boolean,
    val createdAt: Long,
    val updatedAt: Long,
    val lastExecutionTime: Long? = null,
    ...
    override fun toString(): String {
        ...
        nodes.forEach { node ->
            when (node) {
                is com.hermit.data.model.TriggerNode -> {
                ...
                is com.hermit.data.model.ExecuteNode -> {
                ...
                is com.hermit.data.model.ConditionNode -> {
                ...
                is com.hermit.data.model.LogicNode -> {
                ...
                is com.hermit.data.model.ExtractNode -> {
